...
import com.pratamawijaya.wisatajogja.base.BaseActivity;
import com.pratamawijaya.wisatajogja.R;
import com.pratamawijaya.wisatajogja.models.Location;
...
public class AddRouteActivity extends BaseActivity {
  ...
  @Bind(R.id.spinnerDestination) Spinner spDestination;
  ...
  @OnClick(R.id.btnAddMap) public void bntAddMap() {
    startActivityForResult(new Intent(this, AddMapActivity.class), ADD_MAP_KEY);
  }

  @OnClick(R.id.btnGetRoute) public void getRoute() {
